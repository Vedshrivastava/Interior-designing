                ...
                <>
                    <div className="list-table finance-table" style={{ marginBottom: '24px' }}>
                        ...
                        <div className="list-table-format row-item" style={{ gridTemplateColumns: 'repeat(3, 1fr)' }}>
                            ...
                            <p>₹{(data.totals.materialCost + data.totals.materialWasteCost + data.totals.contractorCost + data.totals.commissionCost + data.totals.otherExpenses + data.totals.labourCost).toLocaleString('en-IN')}</p>
