            ...
            {!vendorId ? (
                ...
                <>
                    ...
                    <div className="list-table">
                        <div className="list-table-format title" style={{ gridTemplateColumns: '1fr 1fr 1fr 100px' }}>
                            <b>Date</b><b>Amount</b><b>Account</b><b>Action</b>
                        </div>
                        {loading ? (
                            ...
                            payments.map(p => (
                                <div key={p._id} className="list-table-format row-item" style={{ gridTemplateColumns: '1fr 1fr 1fr 100px' }}>
