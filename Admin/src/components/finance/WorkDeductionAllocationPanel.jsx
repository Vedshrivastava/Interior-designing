                                    ...
                                    {contractors.map(a => {
                                        ...
                                        return (
                                            <div key={key} className="list-table-format row-item" style={{ gridTemplateColumns: '1fr 0.8fr 140px' }}>
                                                ...
                                                <input type="number" min="0" value={sqftInputs[key] || ''} onChange={e => setSqftInputs(p => ({ ...p, [key]: e.target.value }))} />
                                            </div>
                                        );
                                    })}
                                    ...
                                    <div className="list-table" style={{ marginBottom: '16px' }}>
                                        ...
                                        {supervisors.map(s => (
                                            <div key={s.employeeId} className="list-table-format row-item" style={{ gridTemplateColumns: '1fr 0.8fr 140px' }}>
                                                ...
                                                <input type="number" min="0" value={amountInputs[s.employeeId] || ''} onChange={e => setAmountInputs(p => ({ ...p, [s.employeeId]: e.target.value }))} />
                                            </div>
                                        ))}
                                    </div>
                                )}
