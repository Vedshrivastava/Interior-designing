...
// payment/salary payment/commission payment/expense/daily labour/
// supervisor incentive (see those controllers) — not manually re-editable
// through the Cash Book UI; edit the originating record instead. Manual
// entries (nothing set) are for cash with no originating record — petty
// cash, owner draws.
const financeCashEntrySchema = new mongoose.Schema({
    ...
    relatedDailyLabourId:         { type: mongoose.Schema.Types.ObjectId, ref: 'financeDailyLabour', default: null },
