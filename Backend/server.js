...
import financeBankEntryRouter    from "./routes/financeBankEntry.js";
import financeLoanRouter         from "./routes/financeLoan.js";
...
app.use('/api/finance/bank-entries',    financeBankEntryRouter);
app.use('/api/finance/loans',           financeLoanRouter);
