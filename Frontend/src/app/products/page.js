...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: `${SITE_URL}/og-image.png`, width: 1536, height: 1024, alt: 'Interior Products by Shrivastavas Elevate, Satna MP' }],
  },
  twitter: {
    title: 'Interior Products & Materials Satna MP | Shrivastavas Elevate',
...
export default async function Page() {
  ...
  const productCatalogSchema = {
    '@context': 'https://schema.org',
    '@type': 'CollectionPage',
    name: 'Architectural Interior Products in Satna, Madhya Pradesh',
    url: `${SITE_URL}/products`,
  ...
  const imageGallerySchema = initialProducts.length > 0 ? {
    '@context': 'https://schema.org',
    '@type': 'ImageGallery',
    name: 'Interior Products Portfolio by Shrivastavas Elevate, Satna MP',
  ...
  const itemListSchema = initialProducts.length > 0 ? {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: 'Interior Products by Shrivastavas Elevate, Satna MP',
    url: `${SITE_URL}/products`,
