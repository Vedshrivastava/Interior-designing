...
const IconDesigns = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M9.53 16.122a3 3 0 0 0-5.78 1.128 2.25 2.25 0 0 1-2.4 2.245 4.5 4.5 0 0 0 8.4-2.245c0-.399-.078-.78-.22-1.128ZM15 5.25a3 3 0 1 1 6 0 3 3 0 0 1-6 0Zm-9.75 9L12 7.5l3 3-6.75 6.75-3-3Zm0 0-1.5 4.5 4.5-1.5" />
  </svg>
);
...
export default function BottomNavbar() {
  ...
  return (
    <nav className="bottom-nav" aria-label="Mobile navigation">
      ...
      <Link href="/projects" className={`bn-item${pathname === '/projects' ? ' active' : ''}`}>
        <span className="bn-icon"><IconProjects /></span>
        <span className="bn-label">Projects</span>
      </Link>

      <button className="bn-item bn-item--cta" onClick={openConsult} aria-label="Book consultation">
        <span className="bn-icon"><IconConsult /></span>
