    ...
    <footer className='footer' id='footer'>
      ...
      <div className="footer-content">
        ...
        <div className="footer-content-left">
          ...
          <p>
            Shrivastava's Elevate transforms spaces into elegant, functional interiors.
            From luxury home design to commercial renovations, we deliver end-to-end
            contracting solutions with precision, creativity, and craftsmanship.
